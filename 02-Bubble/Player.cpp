...
{
	bJumping = false;
	spritesheet.loadFromFile("images/Soldados1.png", TEXTURE_PIXEL_FORMAT_RGBA);
	sprite = Sprite::createSprite(glm::ivec2(48, 48), glm::vec2(0.25, 0.5), &spritesheet, &shaderProgram);
